clear
label_root_path ='/import/vision-datasets/kl303/PycharmProjects/BSR/bench/pre_label/cluster/test/';
...
%     if strcmp(category,'ambulance')
        ...
        for label_file_idx =1:length(label_file_lists)
            ...
            evaluate_file_path = ['/import/vision-datasets/kl303/PycharmProjects/BSR/bench/PG_data/cluster/',category,'/',label_file_name];
            if ~exist(['/import/vision-datasets/kl303/PycharmProjects/BSR/bench/PG_data/cluster/',category],'file')
                mkdir(['/import/vision-datasets/kl303/PycharmProjects/BSR/bench/PG_data/cluster/',category]);
            end
